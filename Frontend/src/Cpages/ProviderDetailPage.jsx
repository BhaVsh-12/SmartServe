        ...
        <div className="container mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div className="flex-1">
                            ...
                            <p className={`text-lg font-medium ${darkMode ? "text-indigo-400" : "text-indigo-600"}`}>
                                ₹ {provider?.price || "Not Available"} / OneTime
                            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
                <div className="lg:col-span-2">
                    ...
                    <Membership servicemanId={providerId} handleChat={handleChat} />
                    ...
                    <div className={`rounded-xl ${darkMode ? "bg-gray-800" : "bg-white"} shadow-lg p-6`}>
                        ...
                        {reviews.length > 0 ? (
                            <div className="grid lg:grid lg:grid-cols-2 lg:gap-4 lg:gap-y-4 gap-y-6">
                                {reviews.map((review) => (
                                    <motion.div
                                        key={review._id}
