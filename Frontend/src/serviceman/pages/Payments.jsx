    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-2 text-gray-600">Track and manage all your payment transactions</p>
        </motion.div>
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-xl shadow-sm p-6 transition-shadow duration-300 hover:shadow-md"
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full sm:w-auto pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                />
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <select
                  ...
                  className="w-full sm:w-auto border border-gray-300 rounded-lg py-2 px-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <select
                ...
                className="border border-gray-300 rounded-lg py-2 px-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
              >
                        ...
                        <div className="flex items-center">
                          {payment.paymentMethod === 'card' ? (
                            <>
                              ...
                              {payment.status==="completed" ?<span className="text-sm text-gray-900">
                                Card {payment.cardLastFour && `****${payment.cardLastFour}`}
                              </span>:<span className="text-sm text-gray-900">----</span>}
                            </>
                          ) : (
                            <>
